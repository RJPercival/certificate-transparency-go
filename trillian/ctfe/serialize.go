...
func signV1TreeHead(signer *sigs.Signer, sth *ct.SignedTreeHead) error {
...
func buildV1SCT(signer *sigs.Signer, leaf *ct.MerkleTreeLeaf) (*ct.SignedCertificateTimestamp, error) {
